...
#ifndef ISPD_EXA_ENGINE_ROSS_STATIC_MASTER_HPP
#define ISPD_EXA_ENGINE_ROSS_STATIC_MASTER_HPP
...
///\brief The StaticMaster struct is responsible for static schedulers.
///
/// Static schedulers are schedulers which the resource allocation is decided
/// previously. Thus, the Masters does not need slaves feedback
/// to continue the scheduling.
struct StaticMaster{
...
#endif // ISPD_EXA_ENGINE_ROSS_STATIC_MASTER_HPP
