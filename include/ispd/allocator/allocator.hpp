...
/// within a simulation. It defines methods for initializing the allocator and performing
/// forward and reverse allocation of virtual machines.
class Allocator
{
public:
...
/// to allocate the task
  [[nodiscard]] virtual tw_lpid forwardAllocation(std::vector<tw_lpid> &machines, tw_bf *bf,
...
/// The implementation of this method should reverse the allocating operation performed
/// during the forward allocation step.
