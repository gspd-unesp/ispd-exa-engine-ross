...
#ifndef ISPD_ALLOCATOR_FIRST_FIT_DECREASINGHPP
#define ISPD_ALLOCATOR_FIRST_FIT_DECREASINGHPP
#include <ispd/allocator/allocator.hpp>

namespace ispd{
namespace allocator{

/// FFD allocates vms in a decreasing order.
struct firt_fit_decreasing : allocator{
