...
/// struct  used in the cloud simulation. It is an extension of the grid
/// workload that allows user to send multiple tasks. this type of message is
...
struct ispd_cloud_message {
  ...
  double m_SubmitTime; ///< The time at which the application was submitted (in
                       ///< seconds).
  double
      m_EndTime; ///< The time at which the application completed execution (in
  ///< seconds).

  double m_ProcSize; ///< The processing size of the entire application, which
                     ///< is the sum of the processing size of each task
  double m_CommSize; ///< The communication size of the entire application,
                     ///< which is the sum of the comm size of each task.
