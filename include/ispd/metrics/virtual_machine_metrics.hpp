...
struct VirtualMachineMetrics final {
  ...
  double m_ProcMFlops =
      0.0; ///< Total of megaflops processed by this virtual machine

  double m_ProcTime =
      0.0; ///< Total time in seconds the virtual machine spent processing.

  double m_ProcWaitingTime = 0.0; ///< Total time in seconds the tasks wait in
                                  ///< the queue before being executed

  unsigned m_ProcApplications =
      0.0; ///< Total of tasks successfully executed by this virtual machines.
};
