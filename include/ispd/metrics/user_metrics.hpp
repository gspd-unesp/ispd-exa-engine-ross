...
struct UserMetrics final {
  ...
  double m_ProcTime;        ///< The total processing time used by the user (in seconds).
  double m_ProcWaitingTime; ///< The waiting time for processing tasks (in
                            ///< seconds).

  /// \name Communication-related metrics
  double m_CommTime;        ///< The total communication time used by the user (in
                            ///< seconds).
  double m_CommWaitingTime; ///< The waiting time for communication tasks (in
                            ///< seconds).

  /// \name Energy-related metrics
  double m_EnergyConsumption; ///< The total energy consumption by the user (in
                              ///< kJ).

  /// \name Workload-related metrics
  unsigned m_IssuedTasks;    ///< The total number of tasks issued by the user.
  unsigned m_CompletedTasks; ///< The total number of tasks completed by the user.
};
