...
struct UserMetrics final {
  ...
  double m_ProcTime =
      0.0; ///< The total processing time used by the user (in seconds).
  double m_ProcWaitingTime = 0.0; ///< The waiting time for processing tasks (in
                                  ///< seconds).

  /// \name Communication-related metrics
  double m_CommTime = 0.0; ///< The total communication time used by the user
                           ///< (in seconds).
  double m_CommWaitingTime = 0.0; ///< The waiting time for communication tasks
                                  ///< (in seconds).

  /// \name Energy-related metrics
  double m_EnergyConsumption = 0.0; ///< The total energy consumption by the
                                    ///< user (in Joules).
  ...
  unsigned m_CompletedTasks =
      0; ///< The total number of tasks completed by the user.
  unsigned m_IssuedAllocations =
      0; ///< The total number of allocations issued by the user.
  unsigned m_CompletedAllocations =
      0; ///< The total number of virtual machines allocated by the user.
  unsigned m_CompletedApplications =
      0; ///< The total number of applications completed by the user.
  unsigned m_IssuedApplications =
      0; ///< The total number of applications issued by the user.
};
