...
///
/// The MachineConfiguration class encapsulates various parameters related to the
...
public:
  ...
  ///
  /// Initializes a new instance of the MachineConfiguration class with the provided
  /// parameters.
  ///
  ...
  ///
  /// Calculates and returns the time required to process a workload of the given size
  /// based on the machine's load and computational power per core.
  ///
  /// \param processingSize Processing size of the task to be processed (in megaflop).
  ...
  /// \brief Returns the total computational power (in megaflops) of the machine.
  ///
