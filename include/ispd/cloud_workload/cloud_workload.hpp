...
/// \class CloudWorkload
/// \brief A base class representing a workload to be used in the cloud
/// simulation
///
...
protected:
  ...
  ///
  /// The 'm_RemainingApplications' stores the count of applications that are
  /// yet to be generated. It is decremented as applications are generated
  /// during the simulation. This information is important to keep track of the
  /// workload progress.
...
public:
  ...
  /// \param remainingApplications  The total number of applications that needs
  /// to be generated in this workload. \param interarrivalDist An unique
  ...
  virtual void generateWorkload(tw_rng_stream *rng,
                                ispd_cloud_message *application) = 0;
  ...
  ///
  /// \returns The number of applications that are yet to be generated by the
  /// workload.
  ///
  /// \note This function provides access to the `m_RemainingApplications`
  /// member,
  ///       which stores the count of remaining applications. It is used by
  ///       simulation components to monitor the progress of workload generation
  ///       and determine workload generation termination conditions.
...
///
/// \brief  Derived class representing a constant cloud workload for the
/// simulation tasks. All generated tasks will have the same workload
...
public:
  ...
  void generateWorkload(tw_rng_stream *rng,
                        ispd_cloud_message *application) override {
    CHECK_RNG(rng);
